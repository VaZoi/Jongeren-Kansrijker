...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $db->editMedewerker($medewerkerID, $voornaam, $achternaam, $functie, $email);

    header('Location: Overzicht_medewerkers.php');
    exit();
}

$medewerker = $db->selectOneMedewerker($medewerkerID);
...
<header>
    ...
    <div class="container">
        ...
        <form method="post" action="edit_medewerker.php?id=<?php echo $medewerkerID; ?>">
            <label for="voornaam">Voornaam:</label>
            <input type="text" id="voornaam" name="voornaam" value="<?php echo $medewerker['voornaam']; ?>" required>

            <label for="achternaam">Achternaam:</label>
            <input type="text" id="achternaam" name="achternaam" value="<?php echo $medewerker['achternaam']; ?>" required>

            <label for="functie">Functie:</label>
            <input type="text" id="functie" name="functie" value="<?php echo $medewerker['functie']; ?>" required>

            <label for="email">E-mail:</label>
            <input type="email" id="email" name="email" value="<?php echo $medewerker['email']; ?>" required>
